...
from tensorflow.keras.layers import Layer, Add, Dropout, InputSpec
from tensorflow.keras import initializers, constraints, activations
...
class TransformerBlock:
    ...
    - Layer normalization
    """
    def __init__(self, name: str, num_heads: int, use_masking: bool = True):
        self.attention_layer = MultiHeadSelfAttention(num_heads, use_masking=use_masking, name=f'{name}_self_attention')
    ...
    def __call__(self, _input):
        ...
        post_residual1 = (self.addition_layer([_input, output]))
