...
#         attention_heads = tf.reshape(attention_heads, (-1, self.num_heads, seq_len, d_model))
        attention_heads = tf.reshape(attention_heads, (-1, self.num_heads, seq_len, d_submodel))
        attention_heads = K.permute_dimensions(attention_heads, [0, 2, 1, 3])
        attention_heads = tf.reshape(attention_heads,(-1, seq_len, d_model))
